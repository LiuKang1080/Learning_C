...
/* 
    ...
    - Copying Strings:
        ...
        The strcpy() function does NOT check to see if the source string actually fits into the target string. Generally 
        strncpy() is the safer way to copy strings. strncpy() takes in 3 arguments - the 3rd argument specifies the maximum 
        number of characters to copy, specifying how much of the string we want to copy.
